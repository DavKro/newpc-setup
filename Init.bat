...
PowerShell -Command "Get-AppxPackage *Snapfish* | Remove-AppxPackage"
PowerShell -Command "Get-AppxPackage -Name 'king.com.CandyCrushSodaSaga' | Remove-AppxPackage"
...
echo Programs have been removed. Windows Explorer needs to be restarted.
pause
